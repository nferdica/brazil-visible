...
Este projeto adota o [Contributor Covenant v2.1](https://github.com/nferdica/brazil-visible/blob/main/CODE_OF_CONDUCT.md) como código de conduta. Ao participar, espera-se que você siga este código. Reporte comportamentos inaceitáveis para **brazil-visible@proton.me**.
